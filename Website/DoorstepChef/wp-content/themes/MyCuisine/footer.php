	...
	<div id="footer">
		<div class="container">
			...
			<div id="footer-bottom" class="clearfix<?php if ( !is_home() ) echo ' nobg'; ?>">
				...
				?>
				<p id="copyright"><?php esc_html_e('Designed by inLite studio',''); ?> <a href="http://www.elegantthemes.com" title="Premium WordPress Themes"></a>  <?php esc_html_e('','MyCuisine'); ?> <a href="http://www.wordpress.org"></a></p>
